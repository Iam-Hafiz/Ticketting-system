...
export default function Conditions() {
    return (
      ...
      <div data-custom-class="body">
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            <bdt className="question">
              <strong>February 11, 2024</strong>
            </bdt>
          </div>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <bdt className="question">
                  <a
                    href="https://ticketting-system.vercel.app/"
                    target="_blank"
                    data-custom-class="link"
                  >
                    https://ticketting-system.vercel.app/
                  </a>
                </bdt>
              </span>{" "}
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            ...
            <a data-custom-class="link" href="#returnno">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">
                  7. <bdt className="block-component" /> POLICY
                </span>
              </span>
            </a>
            <span style={{ fontSize: 15 }}>
        ...
        <div align="center" style={{ textAlign: "left" }}>
            ...
            >
              ...
              <strong>
                ...
                <span style={{ color: "rgb(0, 58, 250)" }}>
                  ...
                  >
                    <a
                      href="https://www.termsfeed.com/live/24044e3b-2ce5-4188-b9c5-25729873b6a5"
                      target="_blank"
                      data-custom-class="link"
                    >
                      https://www.termsfeed.com/live/24044e3b-2ce5-4188-b9c5-25729873b6a5
                    </a>
                  </bdt>
                </span>
              </strong>
          ...
          >
            ...
            >
              ...
              . <bdt className="question">HelpDesk</bdt> and yourself irrevocably
      ...
      >
        These terms of use were created using Termly&quots{" "}
        <a
